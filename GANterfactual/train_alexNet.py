...
def get_data():
    ...
    train_data = train_gen.flow_from_directory(
        directory="/content/Ganterfactual_histopatho/resources/data/train",
    ...
    validation_data = train_gen.flow_from_directory(
        directory="/content/Ganterfactual_histopatho/resources/data/validation",
        target_size=(image_size, image_size),
        batch_size=batch_size,
        class_mode='categorical',
        shuffle=True,
...
if __name__ == "__main__":
    ...
    model.save(os.path.join("/content/Ganterfactual_histopatho/outputs/models/classifier",'model.h5'), include_optimizer=False)
