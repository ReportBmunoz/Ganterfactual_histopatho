...
if __name__ == '__main__':
    gan = CycleGAN()
    gan.construct(classifier_path=os.path.join("/content/Ganterfactual_histopatho/outputs/models/classifier/model.h5"), classifier_weight=1)
    gan.train(dataset_name=os.path.join("/content/Ganterfactual_histopatho/resources/data"), epochs=1, batch_size=1, print_interval=10,
          sample_interval=100)
    gan.save(os.path.join("/content/Ganterfactual_histopatho/outputs/models/GANterfactual"))
